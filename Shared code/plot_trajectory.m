...
%   pos: Nx2
%       Matrix of positions (columns: x, y)
%   heading: Nx1
...
if animate
    ...
    ToF_left_beam = quiver(x(1), y(1), ToF_left(1) * cos(heading(1) + pi/2), ToF_left(1) * sin(heading(1)+pi/2), 'off', 'b', 'LineWidth', 2);
    ToF_right_beam = quiver(x(1), y(1), ToF_right(1) * cos(heading(1) - pi/2), ToF_right(1) * sin(heading(1)-pi/2), 'off', 'b', 'LineWidth', 2);
    ToF_front_beam = quiver(x(1), y(1), ToF_front(1) * cos(heading(1)), ToF_front(1) * sin(heading(1)), 'off', 'b', 'LineWidth', 2);
